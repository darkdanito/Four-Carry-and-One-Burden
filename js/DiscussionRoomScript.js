...
//					console.log("Testing");
//					console.log("Username from Login: ", loggingUserName );
//					new Firebase('https://c4posit.firebaseIO.com/user/Necrodiver').once('value', function(snap) 
//					{
//						console.log('UserID: ', snap.val().password);
//					});
			
//			var pewpew = document.getElementById('pUserID');
...
//			myFireBase3.push({author:username, message:message, color:color, XPos: dbXPos, YPos:dbYPos });
			
//			myFirebase2.push({password:username, roomName:message, roomPassword:color, roomStatus:dbXPos, username:dbYPos });
